# Clean script - every check should pass

SEGMENT 1.1 (0:00-0:08)
...
WHAT HAPPENS, ONE BEAT PER SECOND:
  ...
  7-8s: the path ahead darkens; hold on this

AUDIO:
  SFX: dry leaf litter crunching underfoot.
  Ambient: wind high in the canopy.
  Not heard: no music, no birdsong.

THE SHOT MUST END ON EXACTLY THIS IMAGE: A dark forest path receding into
shadow with two small figures walking away from camera.

RULES: exactly 8 seconds; one location only.
```
